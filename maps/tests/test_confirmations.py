...
from maps.tests.utils import make_jwt_mock, create_test_marker, BaseMarkerTestCase


class ConfirmationTestCase(BaseMarkerTestCase):
    """Tests for marker confirmations."""
